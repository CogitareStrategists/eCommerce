...
// Small DB helper (server-side only)
writeFile(
...
// Admin API: read home sections + counts
writeFile(
  path.join(root, "app", "api", "admin", "home", "route.ts"),
...
writeFile(
  path.join(root, "app", "admin", "home", "page.tsx"),
...
// Link from /admin dashboard to /admin/home
writeFile(
