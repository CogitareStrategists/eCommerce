...
export default function Page() {
  ...
  async function load() {
    setMsg(null);
    const res = await fetch("/api/admin/home/cure_your_concerns", { cache: "no-store" });
  ...
  async function save() {
    ...
    const res = await fetch("/api/admin/home/cure_your_concerns", {
      method: "POST",
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-end justify-between">
        <div>
          <h1 className="text-2xl font-bold">Home: Cure Your Concerns</h1>
            ...
            return (
              <div key={r.id} className="grid grid-cols-12 items-center px-4 py-3 text-sm">
                ...
                <div className="col-span-2 flex justify-end">
                  <Link className="underline" href={"/admin/concerns/" + r.id + "/edit"}>Edit</Link>
                </div>
              </div>
            );
          })}
